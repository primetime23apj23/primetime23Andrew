          ...
          {(() => {
            ...
            <span 
              ...
              className={cn(
                ...
                factor === "2"
                  ? "bg-green-100 dark:bg-green-900 shadow-[inset_0_0_5px_1px_rgba(34,197,94,0.85)]"
                  : factor === "31"
                  ? "bg-green-100 dark:bg-green-900"
                  : factor === "3"
                  ? "bg-amber-200 dark:bg-amber-800 shadow-[inset_0_0_5px_1px_rgba(245,158,11,0.85)]"
                  : factor === "5"
                  ? "bg-red-200 dark:bg-red-800 shadow-[inset_0_0_5px_1px_rgba(239,68,68,0.85)]"
                  : factor === "7"
                  ? "bg-amber-100 dark:bg-amber-900 shadow-[inset_0_0_5px_1px_rgba(245,158,11,0.75)]"
                  : factor === "11"
