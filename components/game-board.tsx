  ...
  if (space.number === 0) {
    return (
      <div data-space={space.number} className="w-full h-full bg-white dark:bg-zinc-900 flex items-center justify-center p-0.5 overflow-hidden">
        <span 
          className="text-sm sm:text-base md:text-lg font-black text-center leading-none"
          style={{
            ...
            <span 
              ...
              className={cn(
                ...
                factor === "2"
                  ...
                  : factor === "3"
                  ? "bg-amber-200 dark:bg-amber-800 shadow-[inset_0_0_2px_0_rgba(217,119,6,0.9)]"
                  : factor === "5"
                  ? "bg-red-200 dark:bg-red-800 shadow-[inset_0_0_2px_0_rgba(220,38,38,0.9)]"
                  : factor === "7"
                  ? "bg-amber-100 dark:bg-amber-900 shadow-[inset_0_0_2px_0_rgba(217,119,6,0.8)]"
                  : factor === "11"
